...
import InstructorFour from "./InstructorFour";

import 'swiper/css';
import "swiper/css/navigation";
import cls from "./instructorsFourCarousel.module.scss"



const InstructorsFourCarousel = () => {
    const navigation = {
    };
    return (
...
export default InstructorsFourCarousel;