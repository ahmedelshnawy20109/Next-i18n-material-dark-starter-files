...
import cls from "./videoHawas.module.scss"
    ...
    return (
        <div className={cls.video}>
            <Container maxWidth="xl">
                <a>
                    <h1> قناة حواس </h1>
                    <p>نجحت مؤسسة حواس من خلال الأخصائيين المهنيين بأن تنتج مجموعة كبيرة من الافلام الكرتونية، وإضافة إلى ذلك تلحين وغناء مجموعة من الأشعار التربوية والتعليمية في قضايا المجتمع, جميعها للأطفال</p>
                    <div className={cls.btn} onClick={() => setLightBox(true)}>
            ...
            {lightBox === true && <ReactImageVideoLightbox className={cls.lightBox}
                data={[
