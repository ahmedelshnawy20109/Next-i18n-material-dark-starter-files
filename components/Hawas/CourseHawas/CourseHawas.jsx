...
import cls from "./courseHawas.module.scss"

const CourseHawas= (prop) => {
    return (
        <div className={`${cls.card} ${cls[i18n.language]}`}>
            <div className={cls.cardImgContainer}>
                <div className={cls.badgeTop}>
                ...
                <span className={cls.badgeBottom}>
            ...
            <div className={cls.cardFooter}>
                ...
                <Link href="#"><span className={cls.cat}>Photography</span></Link>


                <div className={cls.details}>
                    <Link href="#"><h4>Fashion Photography From Professional</h4></Link>

                    <div className={cls.ratingContainer}>
                        <Rating className={cls.rating} readOnly value={3}></Rating>
                        ...
                        <Grid item xs>
                            <ul className={cls.nav}>
                                ...
                                <li className={cls.navItem}>
                                    ...
                                    <div className={cls.text}>8h 12m</div>
                                </li>
                            </ul>
                        </Grid>
