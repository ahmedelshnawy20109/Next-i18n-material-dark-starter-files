...
import cls from "./introBannerHawas.module.scss"


const IntroBannerHawas = () => {

    return (
        <MouseParallaxContainer>
            <section className={`${cls.intro} ${cls[i18n.language]}`}>
                ...
                <Container maxWidth="xl" className={cls.introContent}>
                    <Grid container alignItems="center">
                        <Grid item xs={12} md={5} lg={6} order={{ md: 2 }} className={cls.bannerImg}>
                            <img src="./imgs/hawas/intro.png" className="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..." />
                        </Grid>
                        <Grid item xs={12} md={7} lg={6} order={{ md: 1 }}>
                            <h1>
                            افضل البرامج التربوية  <span>بوسائل تدريبية متطورة</span>
                            </h1>
                            ...
                            <form>
                                <div className={cls.inputGroup}>
                                    ...
                                    <input type="search" placeholder="ابحث في حواس …" />
                                </div>
                            </form>
...
export default IntroBannerHawas;