...
const Post = (props) => {
    return (
        <div className={`${cls.post} ${cls[i18n.language]}`}>
            <div className={cls.cardZoom}>
                <Link href="#" className={cls.cardImg}>
                    <img src={props.img} alt="..." />
                </Link>
                <Link href="#" className={cls.badge}>
                    <span>Figma</span>
                </Link>
            </div>
            <div className={cls.cardFooter}>
                <ul className={cls.nav}>
                    <li className={cls.navItem}>
                        ...
                        <div className={cls.text}>Jack Wilson</div>
                    </li>
                    <li className={cls.navItem}>
                        <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className={cls.text}>06 April, 2020</div>
                    </li>
                </ul>
                <Link href="#">
                    <h5>The Best Destinations to Begin Your Round the World Trip</h5>
                </Link>
            </div>
        </div>
    )
