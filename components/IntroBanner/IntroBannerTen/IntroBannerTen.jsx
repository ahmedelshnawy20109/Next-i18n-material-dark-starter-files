...
import cls from "./introBannerTen.module.scss"

const IntroBannerTen = () => {
    const pagination = {
        clickable: true,
    };
    const navigation = {
        ...
        <section className={cls.intro}>
            ...
            <div className={cls.intro}>
                <Container maxWidth="xl" className={cls.container}>
                    <div>
                        <Grid container className={cls.content} alignItems="center" spacing={2}>
                            <Grid item md={5} xs={12} order={{ md: 2, xs: 1 }} className={cls.formSection}>
                                <div className={cls.header}>
                                    <h6>TRY IT FREE FOR 7 DAYS STARTING AT $25 A MONTH</h6>
                                </div>
                                <form>
                            ...
                            <Grid item md={7} xs={12} order={{ md: 1, xs: 2 }} className={cls.innerContent}>
                                <h1 >
                                    More Than 40k+ Online Courses
                                </h1>

                                <Link href="#" className={cls.btnPrimary}>VIEW COURSES</Link>
                                <Link href="#" className={cls.videoBtn}>
