...
import cls from "./userDrawer.module.scss"
    ...
    const userDrawerContent = (anchor) => (
        ...
        >
            <div className={cls.drawer}>
                <div className={`${cls.collapse} ${login ? cls.show : ""}`} >
                    <div className={cls.header}>
                        <h5>Log In to Your Skola Account!</h5>
                    ...
                    <div className={cls.body}>
                        <form>
                            ...
                            <div className={cls.formGroup}>
                                ...
                                <input type="email" placeholder="creativelayers" />
                            </div>
                            ...
                            <div className={cls.link}>
                                ...
                                <div>
                                    <a onClick={showPassword}>Forgot Password</a>
                                </div>
                            </div>
                        ...
                        <p >
                            Don't have an account? <a onClick={showSign}>Sign up</a>
                        </p>
                    </div>
                </div>

                <div className={`${cls.collapse} ${signup ? cls.show : ""}`} >
                    <div className={cls.header}>
                    ...
                    <div className={cls.body}>
                        <form>
                            ...
                            <div className={cls.formGroup}>
                                ...
                                <input type="email" placeholder="johndoe@creativelayers.com" />
                            </div>
                ...
                <div className={`${cls.collapse} ${password ? cls.show : ""}`}>
                    <div className={cls.header}>
                    ...
                    <div className={cls.body}>
                        ...
                        <p >
                            Remember your password? <a onClick={showLogin}>Log In</a>
                        </p>
                    </div>
                </div>
            </div>
